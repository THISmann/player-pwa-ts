<template>
    <VueFinalModal class="flex justify-center items-center w-full p-1">
        <div class="grid grid-cols-1 gap-x-4 gap-y-4 bg-white p-6 rounded-lg">
            ...
            <button class="" @click="shareUrl"> <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <path d="M14 6.5L9 10" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
                        <path d="M14 17.5L9 14" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
                        <path
